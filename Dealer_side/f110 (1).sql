...
prompt  APPLICATION 110 - USED_CAR_SALES_MIS_02
--
-- Application Export:
--   Application:     110
--   Name:            USED_CAR_SALES_MIS_02
--   Date and Time:   20:47 Wednesday August 14, 2024
--   Exported By:     JECMCA
--   Flashback:       0
...
wwv_flow_api.create_flow(
  ...
  p_name  => nvl(wwv_flow_application_install.get_application_name,'USED_CAR_SALES_MIS_02'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F110'),
  p_page_view_logging => 'YES',
  p_default_page_template=> 5205321170247504 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=> 5205502445247504 + wwv_flow_api.g_id_offset,
  p_default_region_template=> 5208610334247505 + wwv_flow_api.g_id_offset,
  p_error_template=> 5204903386247503 + wwv_flow_api.g_id_offset,
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt_last_reset => '20240521120156',
  ...
  p_cust_authentication_process=> '.'||to_char(5214212626247507 + wwv_flow_api.g_id_offset)||'.',
  ...
  p_theme_id => 21,
  p_default_label_template => 5212910340247506 + wwv_flow_api.g_id_offset,
  p_default_report_template => 5212226892247506 + wwv_flow_api.g_id_offset,
  p_default_list_template => 5211225740247506 + wwv_flow_api.g_id_offset,
  p_default_menu_template => 5213201417247506 + wwv_flow_api.g_id_offset,
  p_default_button_template => 5206001455247504 + wwv_flow_api.g_id_offset,
  p_default_chart_template => 5207612379247504 + wwv_flow_api.g_id_offset,
  p_default_form_template => 5207719527247505 + wwv_flow_api.g_id_offset,
  p_default_wizard_template => 5209520813247505 + wwv_flow_api.g_id_offset,
  p_default_tabform_template => 5208610334247505 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>5208610334247505 + wwv_flow_api.g_id_offset,
  p_default_menur_template => 5207110146247504 + wwv_flow_api.g_id_offset,
  p_default_listr_template => 5207507418247504 + wwv_flow_api.g_id_offset,
  p_default_irr_template => 5208204477247505 + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'JECMCA',
  p_last_upd_yyyymmddhh24miss=> '20240521120156',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 5214506434247507 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flow_item(
  p_id=> 5220810990247748 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--application/shared_components/navigation/tabs/standard/t_dealer
wwv_flow_api.create_tab (
  p_id=> 5217032718247508 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_DEALER',
  p_tab_text => 'DEALER',
  p_tab_step => 1,
  p_tab_also_current_for_pages => '2,2,1,2,1,2',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/previous_owner
wwv_flow_api.create_tab (
  p_id=> 5244215462447881 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 20,
  p_tab_name=> 'PREVIOUS_OWNER',
  p_tab_text => 'PREVIOUS OWNER',
  p_tab_step => 3,
  p_tab_also_current_for_pages => '4',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/available_cars
wwv_flow_api.create_tab (
  p_id=> 5404806389865834 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 30,
  p_tab_name=> 'AVAILABLE CARS',
  p_tab_text => 'AVAILABLE CARS',
  p_tab_step => 5,
...
wwv_flow_api.create_tab (
  p_id=> 5415432018937656 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 40,
...
--application/shared_components/navigation/tabs/standard/create_bills
wwv_flow_api.create_tab (
  p_id=> 5428020632015436 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 50,
  p_tab_name=> 'CREATE_BILLS',
  p_tab_text => 'CREATE BILLS',
  p_tab_step => 9,
  p_tab_also_current_for_pages => '10',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/t_salesrecord
wwv_flow_api.create_tab (
  p_id=> 5580219253930959 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 60,
  p_tab_name=> 'T_SALESRECORD',
  p_tab_text => 'SALES RECORD',
  p_tab_step => 15,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/admin_login
wwv_flow_api.create_tab (
  p_id=> 5465626559793562 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 90,
  p_tab_name=> 'ADMIN_LOGIN',
  p_tab_text => 'ADMIN LOGIN',
  p_tab_step => 13,
...
--
--application/shared_components/user_interface/lov/fuel_type
 
begin
 
wwv_flow_api.create_list_of_values (
  p_id       => 5292801645189562 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'FUEL TYPE',
  p_lov_query=> '.'||to_char(5292801645189562 + wwv_flow_api.g_id_offset)||'.');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5293119020189564 + wwv_flow_api.g_id_offset,
  p_lov_id=>5292801645189562 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
  p_lov_disp_value=>'PETROL',
  p_lov_return_value=>'PETROL',
  p_lov_data_comment=> '');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5293329534189565 + wwv_flow_api.g_id_offset,
  p_lov_id=>5292801645189562 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>2,
  p_lov_disp_value=>'DIESEL',
  p_lov_return_value=>'DIESEL',
  p_lov_data_comment=> '');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5450527814521986 + wwv_flow_api.g_id_offset,
  p_lov_id=>5292801645189562 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>3,
  p_lov_disp_value=>'ELECTRIC',
  p_lov_return_value=>'ELECTRIC',
  p_lov_data_comment=> '');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5450720672529412 + wwv_flow_api.g_id_offset,
  p_lov_id=>5292801645189562 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>4,
  p_lov_disp_value=>'PETROL HYBRID',
  p_lov_return_value=>'PETROL HYBRID',
  p_lov_data_comment=> '');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5450929330531862 + wwv_flow_api.g_id_offset,
  p_lov_id=>5292801645189562 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>5,
  p_lov_disp_value=>'DIESEL HYBRID',
  p_lov_return_value=>'DIESEL HYBRID',
  p_lov_data_comment=> '');
...
--application/shared_components/user_interface/lov/gender
 
begin
 
wwv_flow_api.create_list_of_values (
  p_id       => 5391025688475394 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'GENDER',
  p_lov_query=> '.'||to_char(5391025688475394 + wwv_flow_api.g_id_offset)||'.');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5391318242475395 + wwv_flow_api.g_id_offset,
  p_lov_id=>5391025688475394 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5391525499475395 + wwv_flow_api.g_id_offset,
  p_lov_id=>5391025688475394 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>2,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5391732369475395 + wwv_flow_api.g_id_offset,
  p_lov_id=>5391025688475394 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>3,
...
wwv_flow_api.create_list_of_values (
  p_id       => 5215717520247508 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'Report Row Per Page',
  p_lov_query=> '.'||to_char(5215717520247508 + wwv_flow_api.g_id_offset)||'.');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5215804938247508 + wwv_flow_api.g_id_offset,
  p_lov_id=>5215717520247508 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5215920795247508 + wwv_flow_api.g_id_offset,
  p_lov_id=>5215717520247508 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5216032379247508 + wwv_flow_api.g_id_offset,
  p_lov_id=>5215717520247508 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5216124327247508 + wwv_flow_api.g_id_offset,
  p_lov_id=>5215717520247508 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5216210116247508 + wwv_flow_api.g_id_offset,
  p_lov_id=>5215717520247508 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5216308448247508 + wwv_flow_api.g_id_offset,
  p_lov_id=>5215717520247508 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5216417541247508 + wwv_flow_api.g_id_offset,
  p_lov_id=>5215717520247508 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5216516789247508 + wwv_flow_api.g_id_offset,
  p_lov_id=>5215717520247508 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5216605727247508 + wwv_flow_api.g_id_offset,
  p_lov_id=>5215717520247508 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5216700228247508 + wwv_flow_api.g_id_offset,
  p_lov_id=>5215717520247508 + wwv_flow_api.g_id_offset,
...
--application/shared_components/user_interface/lov/vehicle_type
 
begin
 
wwv_flow_api.create_list_of_values (
  p_id       => 5447630453513343 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'VEHICLE_TYPE',
  p_lov_query=> '.'||to_char(5447630453513343 + wwv_flow_api.g_id_offset)||'.');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5447916057513344 + wwv_flow_api.g_id_offset,
  p_lov_id=>5447630453513343 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>1,
  p_lov_disp_value=>'SUV',
  p_lov_return_value=>'SUV',
  p_lov_data_comment=> '');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5448118261513344 + wwv_flow_api.g_id_offset,
  p_lov_id=>5447630453513343 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>2,
  p_lov_disp_value=>'SEDAN',
  p_lov_return_value=>'SEDAN',
  p_lov_data_comment=> '');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5448325919513344 + wwv_flow_api.g_id_offset,
  p_lov_id=>5447630453513343 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>3,
  p_lov_disp_value=>'CROSSOVER',
  p_lov_return_value=>'CROSSOVER',
  p_lov_data_comment=> '');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5448510140513344 + wwv_flow_api.g_id_offset,
  p_lov_id=>5447630453513343 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>4,
  p_lov_disp_value=>'HETCHBACK',
  p_lov_return_value=>'HETCHBACK',
  p_lov_data_comment=> '');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5448711437513344 + wwv_flow_api.g_id_offset,
  p_lov_id=>5447630453513343 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>5,
  p_lov_disp_value=>'COUPE',
  p_lov_return_value=>'COUPE',
  p_lov_data_comment=> '');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5448915309513344 + wwv_flow_api.g_id_offset,
  p_lov_id=>5447630453513343 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>6,
  p_lov_disp_value=>'CONVERTIBLE',
  p_lov_return_value=>'CONVERTIBLE',
  p_lov_data_comment=> '');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5449129551513344 + wwv_flow_api.g_id_offset,
  p_lov_id=>5447630453513343 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>7,
  p_lov_disp_value=>'MPV',
  p_lov_return_value=>'MPV',
  p_lov_data_comment=> '');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5449313396513344 + wwv_flow_api.g_id_offset,
  p_lov_id=>5447630453513343 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>8,
  p_lov_disp_value=>'PICKUP',
  p_lov_return_value=>'PICKUP',
  p_lov_data_comment=> '');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5449526050513344 + wwv_flow_api.g_id_offset,
  p_lov_id=>5447630453513343 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>9,
  p_lov_disp_value=>'ELECTRIC VEHICLE',
  p_lov_return_value=>'ELECTRIC VEHICLE',
  p_lov_data_comment=> '');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5449701085513344 + wwv_flow_api.g_id_offset,
  p_lov_id=>5447630453513343 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>10,
  p_lov_disp_value=>'HYBRID',
  p_lov_return_value=>'HYBRID',
  p_lov_data_comment=> '');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5449900298513344 + wwv_flow_api.g_id_offset,
  p_lov_id=>5447630453513343 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>11,
  p_lov_disp_value=>'MINIVAN',
  p_lov_return_value=>'MINIVAN',
  p_lov_data_comment=> '');
...
prompt  ...PAGE 1: Report on DEALER
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 1
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on DEALER'
 ,p_step_title => 'Report on DEALER'
...
'No help is available for this page.'
 ,p_last_updated_by => 'JECMCA'
 ,p_last_upd_yyyymmddhh24miss => '20240521113154'
  );
null;
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select "DEALER_ID", '||chr(10)||
'"NAME",'||chr(10)||
'"PHONE",'||chr(10)||
'"EMAIL",'||chr(10)||
'"ESTD_YEAR",'||chr(10)||
'"ADDRESS"'||chr(10)||
'from "#OWNER#"."DEALER" where "DEALER_ID" = :P14_DEALER_ID'||chr(10)||
'  '||chr(10)||
'';

wwv_flow_api.create_page_plug (
  p_id=> 5237110612358109 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Report on DEALER',
  p_region_name=>'',
  p_plug_template=> 5208204477247505+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet(
  p_id=> 5237305462358109+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_region_id=> 5237110612358109+wwv_flow_api.g_id_offset,
  p_name=> 'Report on DEALER',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_detail_link=>'f?p=&APP_ID.:2:&APP_SESSION.::::P2_DEALER_ID:#DEALER_ID#',
...
wwv_flow_api.create_worksheet_column(
  p_id => 5237403229358110+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 5237305462358109+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5237518223358110+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 5237305462358109+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5237617544358110+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 5237305462358109+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5237707899358110+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 5237305462358109+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5237810706358110+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 5237305462358109+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ESTD_YEAR',
  p_display_order          =>5,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'E',
  p_column_label           =>'Estd Year',
  p_report_label           =>'Estd Year',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5237928193358111+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 5237305462358109+wwv_flow_api.g_id_offset,
...
begin
rc1:=rc1||'DEALER_ID:NAME:PHONE:EMAIL:ESTD_YEAR:ADDRESS';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5238200788358345+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 5237305462358109+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_button(
  p_id             => 5238105131358111 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1,
  p_button_sequence=> 30,
  p_button_plug_id => 5237110612358109+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page (
 ...
 ,p_id => 2
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on DEALER'
 ,p_step_title => 'Form on DEALER'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_javascript_code => 
...
'No help is available for this page.'
 ,p_last_updated_by => 'JECMCA'
 ,p_last_upd_yyyymmddhh24miss => '20240521112908'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5240004357417248 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Form on DEALER',
  p_region_name=>'',
  p_plug_template=> 5207719527247505+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
wwv_flow_api.create_page_button(
  p_id             => 5240324846417248 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 2,
  p_button_sequence=> 30,
  p_button_plug_id => 5240004357417248+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  ...
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P2_DEALER_ID',
...
wwv_flow_api.create_page_button(
  p_id             => 5240600267417248 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 2,
...
wwv_flow_api.create_page_button(
  p_id             => 5240219662417248 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 2,
...
wwv_flow_api.create_page_button(
  p_id             => 5240401903417248 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 2,
...
wwv_flow_api.create_page_branch(
  p_id=>5241203209417249 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
...
wwv_flow_api.create_page_item(
  p_id=>5241413811417249 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_DEALER_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_item_sequence=> 1,
  p_item_plug_id => 5240004357417248+wwv_flow_api.g_id_offset,
  ...
  p_field_template=> 5212910340247506+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_01 => 'Y',
  p_item_comment => '');
...
begin
wwv_flow_api.create_page_item(
  p_id=>5241605849417249 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_NAME',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5241824205417249 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_PHONE',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5242009585417250 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_EMAIL',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5242205735417250 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_ESTD_YEAR',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5242400758417250 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_ADDRESS',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_validation(
  p_id => 5582827828269907 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 2,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'P2_PHONE',
  p_validation_sequence=> 10,
  p_validation => 'is_dealer_phone(:P2_PHONE) = 1',
  p_validation_type => 'PLSQL_EXPRESSION',
  p_error_message => '*Phone number already exists or invalid',
  p_always_execute=>'N',
  p_when_button_pressed=> 5240219662417248 + wwv_flow_api.g_id_offset,
  p_associated_item=> 5241824205417249 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_validation(
  p_id => 5583023504306449 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 2,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'P2_EMAIL',
  p_validation_sequence=> 20,
  p_validation => 'is_email_in_dealer(:P2_EMAIL) = 1',
  p_validation_type => 'PLSQL_EXPRESSION',
  p_error_message => '*Email id already exists or invalid',
  p_always_execute=>'N',
  p_when_button_pressed=> 5240219662417248 + wwv_flow_api.g_id_offset,
  p_associated_item=> 5242009585417250 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:DEALER:P2_DEALER_ID:DEALER_ID';

wwv_flow_api.create_page_process(
  p_id     => 5242718650417250 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 2,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from DEALER',
...
'  end; '||chr(10)||
'begin '||chr(10)||
'  :P2_DEALER_ID := get_pk; '||chr(10)||
'end; ';

wwv_flow_api.create_page_process(
  p_id     => 5242926416417250 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 2,
  p_process_sequence=> 10,
  ...
  p_process_when_button_id=>5240219662417248 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:DEALER:P2_DEALER_ID:DEALER_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5243122141417250 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 2,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of DEALER',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table DEALER.',
...
wwv_flow_api.create_page_process(
  p_id     => 5243307981417250 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 2,
  ...
  p_process_when_button_id=>5240401903417248 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
prompt  ...PAGE 3: Report on PREV_OWNER
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 3
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on PREV_OWNER'
 ,p_step_title => 'Report on PREV_OWNER'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_updated_by => 'JECMCA'
 ,p_last_upd_yyyymmddhh24miss => '20240518232315'
  );
null;
...
'FROM ('||chr(10)||
'    SELECT '||chr(10)||
'        p.PREV_OWNER_ID, '||chr(10)||
'        p.NAME,'||chr(10)||
'        p.GENDER,'||chr(10)||
'        p.PHONE,'||chr(10)||
'        p.EMAIL,'||chr(10)||
'        p.ADDRESS,'||chr(10)||
'        ROW_NUMBER() OVER (PARTITION BY p.PREV_OWNER_ID ORDER BY p.PREV_OWNER_ID) AS rn'||chr(10)||
'    FROM '||chr(10)||
'        "#OWNER#"."PREV_OWNER" p'||chr(10)||
'    JOIN '||chr(10)||
'        "#OWNER#"."USED_CAR" u'||chr(10)||
'    ON '||chr(10)||
'    ';

s:=s||'    p.PREV_OWNER_ID = u.PREV_OWNER_ID'||chr(10)||
'    WHERE '||chr(10)||
'        u.DEALER_ID = :P14_DEALER_ID'||chr(10)||
')'||chr(10)||
'WHERE '||chr(10)||
'    rn = 1;'||chr(10)||
'';
...
wwv_flow_api.create_page_plug (
  p_id=> 5248215954447887 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_plug_name=> 'Report on PREV_OWNER',
  p_region_name=>'',
  p_plug_template=> 5208204477247505+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
a1:=a1||'    p.PREV_OWNER_ID = u.PREV_OWNER_ID'||chr(10)||
'    WHERE '||chr(10)||
'        u.DEALER_ID = :P14_DEALER_ID'||chr(10)||
')'||chr(10)||
'WHERE '||chr(10)||
...
wwv_flow_api.create_worksheet(
  p_id=> 5248407711447888+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_region_id=> 5248215954447887+wwv_flow_api.g_id_offset,
  p_name=> 'Report on PREV_OWNER',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:4:&APP_SESSION.::::P4_PREV_OWNER_ID:#PREV_OWNER_ID#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#e2.gif"  border="0">',
  p_allow_exclude_null_values=>'Y',
  p_allow_hide_extra_columns=>'Y',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5248518925447888+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 5248407711447888+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PREV_OWNER_ID',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
  p_column_label           =>'Prev Owner Id',
  p_report_label           =>'Prev Owner Id',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5248605240447888+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 5248407711447888+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'NAME',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5248726689447889+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 5248407711447888+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5248813679447889+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 5248407711447888+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PHONE',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5248902913447889+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 5248407711447888+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'EMAIL',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5249012215447889+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 5248407711447888+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ADDRESS',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'PREV_OWNER_ID:NAME:GENDER:PHONE:EMAIL:ADDRESS';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5249316512448023+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 5248407711447888+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_button(
  p_id             => 5249205248447889 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 3,
  p_button_sequence=> 30,
  p_button_plug_id => 5248215954447887+wwv_flow_api.g_id_offset,
  p_button_name    => 'CREATE',
  p_button_image_alt=> 'Create',
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
...
prompt  ...PAGE 4: Form on PREV_OWNER
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 4
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on PREV_OWNER'
 ,p_step_title => 'Form on PREV_OWNER'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_javascript_code => 
'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5244307441447881 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'Form on PREV_OWNER',
  p_region_name=>'',
  p_plug_template=> 5207719527247505+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
wwv_flow_api.create_page_button(
  p_id             => 5244621978447883 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 4,
  p_button_sequence=> 30,
  p_button_plug_id => 5244307441447881+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_image_alt=> 'Apply Changes',
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P4_PREV_OWNER_ID',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_button_cattributes=>'class="btn btn-primary"',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  p_id             => 5244922699447883 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 4,
  p_button_sequence=> 10,
  p_button_plug_id => 5244307441447881+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5244513950447883 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 4,
  p_button_sequence=> 40,
  p_button_plug_id => 5244307441447881+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5244728020447883 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 4,
  p_button_sequence=> 20,
  p_button_plug_id => 5244307441447881+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>5245526765447884 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5245717816447884 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_name=>'P4_PREV_OWNER_ID',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5244307441447881+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Prev Owner Id',
  p_source=>'PREV_OWNER_ID',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_HIDDEN',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5245905145447884 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_name=>'P4_NAME',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5246105256447884 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_name=>'P4_GENDER',
  p_data_type=> 'VARCHAR',
  ...
  p_named_lov=> 'GENDER',
  p_lov=> '.'||to_char(5391025688475394 + wwv_flow_api.g_id_offset)||'.',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 32,
  p_cMaxlength=> 10,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5246318689447884 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_name=>'P4_PHONE',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5246510881447885 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_name=>'P4_EMAIL',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5246719601447885 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_name=>'P4_ADDRESS',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:PREV_OWNER:P4_PREV_OWNER_ID:PREV_OWNER_ID';

wwv_flow_api.create_page_process(
  p_id     => 5247027037447885 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 4,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from PREV_OWNER',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to fetch row.',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
...
'   L_PRIMARY_KEY NUMBER;'||chr(10)||
'BEGIN'||chr(10)||
'   SELECT MAX(PREV_OWNER_ID) + 1'||chr(10)||
'   INTO   L_PRIMARY_KEY'||chr(10)||
'   FROM   PREV_OWNER;'||chr(10)||
''||chr(10)||
'   RETURN L_PRIMARY_KEY;'||chr(10)||
'END;'||chr(10)||
'  end; '||chr(10)||
'begin '||chr(10)||
'  :P4_PREV_OWNER_ID := get_pk; '||chr(10)||
'end; ';

wwv_flow_api.create_page_process(
  p_id     => 5247216787447886 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 4,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to get primary key item value.',
  p_process_when_button_id=>5244513950447883 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:PREV_OWNER:P4_PREV_OWNER_ID:PREV_OWNER_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5247407569447886 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 4,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of PREV_OWNER',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table PREV_OWNER.',
  p_process_success_message=> 'Action Processed.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page_process(
  p_id     => 5247625374447886 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 4,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>5244728020447883 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
prompt  ...PAGE 5: Report on USED_CAR
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 5
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on USED_CAR'
 ,p_step_title => 'Report on USED_CAR'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_updated_by => 'JECMCA'
 ,p_last_upd_yyyymmddhh24miss => '20240518195322'
  );
null;
...
'    KM_PER_LITER,'||chr(10)||
'    VEHICLE_TYPE,'||chr(10)||
'    TOTAL_KM_DRIVEN,'||chr(10)||
'    REGISTRATION_NUMBER,'||chr(10)||
'    MAKE_MONTH_AND_YEAR,'||chr(10)||
'    BUYING_DATE,'||chr(10)||
'    CAR_AGE,'||chr(10)||
'    PURCHASE_AMOUNT,'||chr(10)||
'    RESALE_MRP,'||chr(10)||
'    DISCOUNT'||chr(10)||
'from  USED_CAR where ISAVAILABLE = ''AVAILABLE'' AND DEALER_ID = :P14_DEALER_ID';

wwv_flow_api.create_page_plug (
  p_id=> 5411000636865853 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_plug_name=> 'Report on USED_CAR',
  p_region_name=>'',
  p_plug_template=> 5208204477247505+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
wwv_flow_api.create_worksheet(
  p_id=> 5411205715865853+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_region_id=> 5411000636865853+wwv_flow_api.g_id_offset,
  p_name=> 'Report on USED_CAR',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:6:&APP_SESSION.::::P6_CAR_ID:#CAR_ID#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#e2.gif"  border="0">',
  p_allow_exclude_null_values=>'Y',
  p_allow_hide_extra_columns=>'Y',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5411328750865854+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5411205715865853+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5411410088865854+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5411205715865853+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5411508781865854+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5411205715865853+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5411617852865855+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5411205715865853+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5411714444865855+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5411205715865853+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5411932599865855+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5411205715865853+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5412124459865856+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5411205715865853+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5412328876865856+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5411205715865853+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'BUYING_DATE',
  p_display_order          =>11,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'K',
  p_column_label           =>'Buying Date',
  p_report_label           =>'Buying Date',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5412423609865857+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5411205715865853+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5414124027881243+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5411205715865853+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5414213101881243+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5411205715865853+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5414306410881243+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5411205715865853+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5537624185399858+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5411205715865853+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5537714687399858+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5411205715865853+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5537930550411143+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5411205715865853+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PURCHASE_AMOUNT',
  p_display_order          =>25,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'Y',
  p_column_label           =>'Purchase Amount',
  p_report_label           =>'Purchase Amount',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'CAR_ID:CAR_NAME:MODEL:COLOR:FUEL:KM_PER_LITER:VEHICLE_TYPE:TOTAL_KM_DRIVEN:REGISTRATION_NUMBER:MAKE_MONTH_AND_YEAR:BUYING_DATE:CAR_AGE:PURCHASE_AMOUNT:RESALE_MRP:DISCOUNT:SOLD_PRICE:PROFIT:ISAVAILABLE:DEALER_NAME:DEALER_ID:PREV_OWNER_ID';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5413606927866832+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5411205715865853+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_button(
  p_id             => 5413500409865859 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
  p_button_sequence=> 30,
  p_button_plug_id => 5411000636865853+wwv_flow_api.g_id_offset,
  p_button_name    => 'CREATE',
  p_button_image_alt=> 'Create',
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
...
prompt  ...PAGE 6: Form on USED_CAR
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 6
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on USED_CAR'
 ,p_step_title => 'Form on USED_CAR'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_javascript_code => 
'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5404900058865834 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_plug_name=> 'Form on USED_CAR',
  p_region_name=>'',
  p_plug_template=> 5207719527247505+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
wwv_flow_api.create_page_button(
  p_id             => 5405202746865834 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 6,
  p_button_sequence=> 30,
  p_button_plug_id => 5404900058865834+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_image_alt=> 'Apply Changes',
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  p_button_alignment=> 'RIGHT',
...
wwv_flow_api.create_page_button(
  p_id             => 5405520130865835 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 6,
  p_button_sequence=> 10,
  p_button_plug_id => 5404900058865834+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5405115975865834 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 6,
  p_button_sequence=> 40,
  p_button_plug_id => 5404900058865834+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5405309384865834 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 6,
  p_button_sequence=> 20,
  p_button_plug_id => 5404900058865834+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>5406125540865835 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5406325894865836 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_CAR_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5404900058865834+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Car Id',
  p_source=>'CAR_ID',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5406513779865843 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_CAR_NAME',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5406717948865843 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_MODEL',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5406903744865843 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_COLOR',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5407125132865844 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_FUEL',
  p_data_type=> 'VARCHAR',
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_named_lov=> 'FUEL TYPE',
  p_lov=> '.'||to_char(5292801645189562 + wwv_flow_api.g_id_offset)||'.',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 32,
  p_cMaxlength=> 255,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5407323081865844 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_KM_PER_LITER',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 60,
  p_item_plug_id => 5404900058865834+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Km Per Liter',
  p_source=>'KM_PER_LITER',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_TEXT_FIELD',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5407526104865844 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_VEHICLE_TYPE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 70,
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_named_lov=> 'VEHICLE_TYPE',
  p_lov=> '.'||to_char(5447630453513343 + wwv_flow_api.g_id_offset)||'.',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 32,
  p_cMaxlength=> 255,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5407727190865844 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_TOTAL_KM_DRIVEN',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 80,
  p_item_plug_id => 5404900058865834+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Total Km Driven',
  p_source=>'TOTAL_KM_DRIVEN',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_NUMBER_FIELD',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5407927075865844 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_REGISTRATION_NUMBER',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 90,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5408124948865844 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_MAKE_MONTH_AND_YEAR',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 100,
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Make Month And Year in: MM-YYYY',
  p_source=>'MAKE_MONTH_AND_YEAR',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_TEXT_FIELD',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5408323669865845 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_BUYING_DATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 110,
  p_item_plug_id => 5404900058865834+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Buying Date',
  p_source=>'BUYING_DATE',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_DATE_PICKER',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5408516077865845 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_PURCHASE_AMOUNT',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 130,
  p_item_plug_id => 5404900058865834+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Purchase Amount',
  p_source=>'PURCHASE_AMOUNT',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_TEXT_FIELD',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5408727159865845 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_RESALE_MRP',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 140,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5408907686865845 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_DISCOUNT',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5409117692865845 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_DEALER_NAME',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 190,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5409325277865845 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_DEALER_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'SELECT NAME d, DEALER_ID r FROM DEALER WHERE DEALER_ID = :P14_DEALER_ID',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 32,
  p_cMaxlength=> 255,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5409526376865846 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_PREV_OWNER_ID',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 210,
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Prev Owner Phone Number',
  p_source=>'PREV_OWNER_ID',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_NUMBER_FIELD',
  p_lov_display_null=> 'NO',
...
wwv_flow_api.create_page_validation(
  p_id => 5582007555150476 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 6,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'P6_REGISTRATION_NUMBER',
  p_validation_sequence=> 10,
  p_validation => 'is_car_registered(:P6_REGISTRATION_NUMBER) = 1',
  p_validation_type => 'PLSQL_EXPRESSION',
  p_error_message => '*Either car is registered or registration number is incorrect',
  p_always_execute=>'N',
  p_when_button_pressed=> 5405115975865834 + wwv_flow_api.g_id_offset,
  p_associated_item=> 5407927075865844 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
wwv_flow_api.create_page_validation(
  p_id => 5584716596455830 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 6,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'P6_DISCOUNT',
  p_validation_sequence=> 20,
  p_validation => 'is_amount(:P6_DISCOUNT, :P6_PURCHASE_AMOUNT, :P6_RESALE_MRP) = 1',
  p_validation_type => 'PLSQL_EXPRESSION',
  p_error_message => '*Discount or purchase amount or resale mrp cannot be empty',
  p_always_execute=>'N',
  p_when_button_pressed=> 5405115975865834 + wwv_flow_api.g_id_offset,
  p_associated_item=> 5408907686865845 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:USED_CAR:P6_CAR_ID:CAR_ID';

wwv_flow_api.create_page_process(
  p_id     => 5409824930865847 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 6,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from USED_CAR',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to fetch row.',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
...
'  end; '||chr(10)||
'begin '||chr(10)||
'  :P6_CAR_ID := get_pk; '||chr(10)||
'end; ';

wwv_flow_api.create_page_process(
  p_id     => 5410024670865847 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 6,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to get primary key item value.',
  p_process_when_button_id=>5405115975865834 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:USED_CAR:P6_CAR_ID:CAR_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5410217856865847 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 6,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of USED_CAR',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table USED_CAR.',
  p_process_success_message=> 'Action Processed.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page_process(
  p_id     => 5410430943865848 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 6,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>5405309384865834 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
'No help is available for this page.'
 ,p_last_updated_by => 'JECMCA'
 ,p_last_upd_yyyymmddhh24miss => '20240520231548'
  );
null;
...
'    c.ADDRESS'||chr(10)||
'FROM '||chr(10)||
'    "#OWNER#".CUSTOMER c'||chr(10)||
'LEFT JOIN '||chr(10)||
'    "#OWNER#".BILLS b ON c.CUSTOMER_ID = b.CUSTOMER_ID AND b.DEALER_ID = :P14_DEALER_ID'||chr(10)||
'WHERE '||chr(10)||
'    b.CUSTOMER_ID IS NOT NULL';

wwv_flow_api.create_report_region (
  p_id=> 5574724194895895 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_name=> 'Report 1',
  p_region_name=>'',
  p_template=> 5208610334247505+ wwv_flow_api.g_id_offset,
  ...
  p_plug_caching=> 'NOT_CACHED',
  p_ajax_enabled=> 'Y',
  p_query_row_template=> 5212226892247506+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_report_columns (
  p_id=> 5575014810895904 + wwv_flow_api.g_id_offset,
  p_region_id=> 5574724194895895 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5575121039895905 + wwv_flow_api.g_id_offset,
  p_region_id=> 5574724194895895 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5575230203895905 + wwv_flow_api.g_id_offset,
  p_region_id=> 5574724194895895 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5575315261895905 + wwv_flow_api.g_id_offset,
  p_region_id=> 5574724194895895 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5575423890895905 + wwv_flow_api.g_id_offset,
  p_region_id=> 5574724194895895 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5575516541895905 + wwv_flow_api.g_id_offset,
  p_region_id=> 5574724194895895 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
wwv_flow_api.create_page (
 ...
 ,p_id => 9
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on BILLS'
 ,p_step_title => 'Report on BILLS'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_updated_by => 'JECMCA'
 ,p_last_upd_yyyymmddhh24miss => '20240518232338'
  );
null;
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select "BILL_ID", '||chr(10)||
'"CAR_NAME",'||chr(10)||
'"REGISTRATION_NUMBER",'||chr(10)||
'"ORIGINAL_PRICE",'||chr(10)||
'"DISCOUNT",'||chr(10)||
'"AMOUNT_PAID",'||chr(10)||
'"BILLING_DATE",'||chr(10)||
'"DEALER_NAME",'||chr(10)||
'"CUSTOMAR_NAME"'||chr(10)||
'from "#OWNER#"."BILLS" where DEALER_ID = :P14_DEALER_ID ORDER BY BILL_ID'||chr(10)||
'  '||chr(10)||
'';

wwv_flow_api.create_page_plug (
  p_id=> 5431803296015441 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_plug_name=> 'Report on BILLS',
  p_region_name=>'',
  p_plug_template=> 5208204477247505+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
wwv_flow_api.create_worksheet(
  p_id=> 5432005277015441+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_region_id=> 5431803296015441+wwv_flow_api.g_id_offset,
  p_name=> 'Report on BILLS',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:10:&APP_SESSION.::::P10_BILL_ID:#BILL_ID#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#e2.gif"  border="0">',
  p_allow_exclude_null_values=>'Y',
  p_allow_hide_extra_columns=>'Y',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5432101827015441+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_worksheet_id => 5432005277015441+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5432225657015441+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_worksheet_id => 5432005277015441+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CAR_NAME',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5432311076015442+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_worksheet_id => 5432005277015441+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'REGISTRATION_NUMBER',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5432706949015443+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_worksheet_id => 5432005277015441+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5432828561015443+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_worksheet_id => 5432005277015441+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5432905782015443+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_worksheet_id => 5432005277015441+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CUSTOMAR_NAME',
  p_display_order          =>9,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'I',
  p_column_label           =>'Customar Name',
  p_report_label           =>'Customar Name',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5434000151025759+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_worksheet_id => 5432005277015441+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5434129152025759+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_worksheet_id => 5432005277015441+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'DISCOUNT',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5434224263025760+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_worksheet_id => 5432005277015441+wwv_flow_api.g_id_offset,
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'BILL_ID:CAR_NAME:REGISTRATION_NUMBER:ORIGINAL_PRICE:DISCOUNT:AMOUNT_PAID:BILLING_DATE:DEALER_NAME:CUSTOMAR_NAME:CUSTOMER_ID:CAR_ID:DEALER_ID';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5433530363015600+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_worksheet_id => 5432005277015441+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_button(
  p_id             => 5433407021015444 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 30,
  p_button_plug_id => 5431803296015441+wwv_flow_api.g_id_offset,
  p_button_name    => 'CREATE',
  p_button_image_alt=> 'Create',
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
...
wwv_flow_api.create_page (
 ...
 ,p_id => 10
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on BILLS'
 ,p_step_title => 'Form on BILLS'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_javascript_code => 
'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5428113125015436 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 10,
  p_plug_name=> 'Form on BILLS',
  p_region_name=>'',
  p_plug_template=> 5207719527247505+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
wwv_flow_api.create_page_button(
  p_id             => 5428428074015437 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 10,
  p_button_sequence=> 30,
  p_button_plug_id => 5428113125015436+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_image_alt=> 'Apply Changes',
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P10_BILL_ID',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_button_cattributes=>'class="btn btn-primary"',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  p_id             => 5428706187015437 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 10,
  p_button_sequence=> 10,
  p_button_plug_id => 5428113125015436+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5428328244015437 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 10,
  p_button_sequence=> 40,
  p_button_plug_id => 5428113125015436+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5428521274015437 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 10,
  p_button_sequence=> 20,
  p_button_plug_id => 5428113125015436+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>5429319694015438 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5429504304015438 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  p_name=>'P10_BILL_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5428113125015436+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Bill Id',
  p_source=>'BILL_ID',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5429715259015438 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  p_name=>'P10_REGISTRATION_NUMBER',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5429904067015438 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  p_name=>'P10_BILLING_DATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 70,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5430116102015439 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  p_name=>'P10_CUSTOMAR_NAME',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 90,
  p_item_plug_id => 5428113125015436+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Customar Name',
  p_source=>'CUSTOMAR_NAME',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_TEXT_FIELD',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5430309085015439 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Customer Phone Number',
...
wwv_flow_api.create_page_validation(
  p_id => 5434620283059924 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'P10_REGISTRATION_NUMBER',
  p_validation_sequence=> 20,
  p_validation => 'check_car_registration(:P10_REGISTRATION_NUMBER) = 1',
  p_validation_type => 'PLSQL_EXPRESSION',
  p_error_message => '*Either car is sold or registration number is invalid',
  p_always_execute=>'N',
  p_when_button_pressed=> 5428328244015437 + wwv_flow_api.g_id_offset,
  p_associated_item=> 5429715259015438 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
wwv_flow_api.create_page_validation(
  p_id => 5435029811100594 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'P10_BILLING_DATE',
  p_validation_sequence=> 40,
  p_validation => 'check_billing_date(:P10_BILLING_DATE, :P10_REGISTRATION_NUMBER) = 1',
  p_validation_type => 'PLSQL_EXPRESSION',
  p_error_message => '*Billing date should be greater than purchase date',
  p_always_execute=>'N',
  p_when_button_pressed=> 5428328244015437 + wwv_flow_api.g_id_offset,
  p_associated_item=> 5429904067015438 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
wwv_flow_api.create_page_validation(
  p_id => 5446028828554441 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'P10_CUSTOMER_ID',
  p_validation_sequence=> 50,
  p_validation => 'check_is_phone(:P10_CUSTOMER_ID) = 1',
  p_validation_type => 'PLSQL_EXPRESSION',
  p_error_message => '*Invalid phone number',
  p_always_execute=>'N',
  p_when_button_pressed=> 5428328244015437 + wwv_flow_api.g_id_offset,
  p_associated_item=> 5430309085015439 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
wwv_flow_api.create_page_validation(
  p_id => 5446727639743538 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'P10_CUSTOMAR_NAME',
  p_validation_sequence=> 60,
  p_validation => 'validate_name(:P10_CUSTOMAR_NAME) = 1',
  p_validation_type => 'PLSQL_EXPRESSION',
  p_error_message => '*Invalid customer name',
  p_always_execute=>'N',
  p_when_button_pressed=> 5428328244015437 + wwv_flow_api.g_id_offset,
  p_associated_item=> 5430116102015439 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:BILLS:P10_BILL_ID:BILL_ID';

wwv_flow_api.create_page_process(
  p_id     => 5430613167015439 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from BILLS',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to fetch row.',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
...
'  end; '||chr(10)||
'begin '||chr(10)||
'  :P10_BILL_ID := get_pk; '||chr(10)||
'end; ';

wwv_flow_api.create_page_process(
  p_id     => 5430821856015439 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to get primary key item value.',
  p_process_when_button_id=>5428328244015437 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:BILLS:P10_BILL_ID:BILL_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5431026505015439 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of BILLS',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table BILLS.',
  p_process_success_message=> 'Action Processed.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page_process(
  p_id     => 5431221419015440 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>5428521274015437 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
prompt  ...PAGE 13: Report on ADMIN_LOGIN
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 13
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on ADMIN_LOGIN'
 ,p_step_title => 'Report on ADMIN_LOGIN'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_updated_by => 'JECMCA'
 ,p_last_upd_yyyymmddhh24miss => '20240518232354'
  );
null;
...
'"DEALER_ID",'||chr(10)||
'"EMAIL"'||chr(10)||
'from "#OWNER#"."ADMIN_LOGIN" where DEALER_ID = :P14_DEALER_ID AND ROWNUM = 1;'||chr(10)||
'  '||chr(10)||
'';

wwv_flow_api.create_page_plug (
  p_id=> 5469018636793564 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 13,
  p_plug_name=> 'Report on ADMIN_LOGIN',
  p_region_name=>'',
  p_plug_template=> 5208204477247505+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
wwv_flow_api.create_worksheet(
  p_id=> 5469231376793564+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 13,
  p_region_id=> 5469018636793564+wwv_flow_api.g_id_offset,
  p_name=> 'Report on ADMIN_LOGIN',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:14:&APP_SESSION.::::P14_LOGIN_ID:#LOGIN_ID#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#e2.gif"  border="0">',
  p_allow_exclude_null_values=>'Y',
  p_allow_hide_extra_columns=>'Y',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5469414379793565+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 13,
  p_worksheet_id => 5469231376793564+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'DEALER_ID',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5469527114793565+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 13,
  p_worksheet_id => 5469231376793564+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'EMAIL',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'LOGIN_ID:DEALER_ID:EMAIL';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5469819308793684+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 13,
  p_worksheet_id => 5469231376793564+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_button(
  p_id             => 5469721286793565 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 13,
  p_button_sequence=> 30,
  p_button_plug_id => 5469018636793564+wwv_flow_api.g_id_offset,
  p_button_name    => 'CREATE',
...
prompt  ...PAGE 14: Form on ADMIN_LOGIN
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 14
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on ADMIN_LOGIN'
 ,p_step_title => 'Form on ADMIN_LOGIN'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_javascript_code => 
'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5465716537793562 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 14,
  p_plug_name=> 'Form on ADMIN_LOGIN',
  p_region_name=>'',
  p_plug_template=> 5207719527247505+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
wwv_flow_api.create_page_button(
  p_id             => 5466024625793562 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 14,
  p_button_sequence=> 30,
  p_button_plug_id => 5465716537793562+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_image   => 'template:'||to_char(5206001455247504+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Apply Changes',
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P14_LOGIN_ID',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 5466318491793562 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 14,
  p_button_sequence=> 10,
  p_button_plug_id => 5465716537793562+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5465918912793562 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 14,
  p_button_sequence=> 40,
  p_button_plug_id => 5465716537793562+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5466114520793562 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 14,
  p_button_sequence=> 20,
  p_button_plug_id => 5465716537793562+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>5466912040793562 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 14,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5467123244793562 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 14,
  p_name=>'P14_LOGIN_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5465716537793562+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Login Id',
  p_source=>'LOGIN_ID',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5467301135793563 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 14,
  p_name=>'P14_DEALER_ID',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 20,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5467529998793563 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 14,
  p_name=>'P14_EMAIL',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_validation(
  p_id => 5478306191969427 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 14,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'P14_EMAIL',
  p_validation_sequence=> 20,
  p_validation => 'check_is_admin(:P14_DEALER_ID, :P14_EMAIL) = 1',
  p_validation_type => 'PLSQL_EXPRESSION',
  p_error_message => '*Invalid id or password',
  p_always_execute=>'N',
  p_when_button_pressed=> 5465918912793562 + wwv_flow_api.g_id_offset,
  p_associated_item=> 5467529998793563 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:ADMIN_LOGIN:P14_LOGIN_ID:LOGIN_ID';

wwv_flow_api.create_page_process(
  p_id     => 5467826857793563 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 14,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from ADMIN_LOGIN',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to fetch row.',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
...
'   L_PRIMARY_KEY NUMBER;'||chr(10)||
'BEGIN'||chr(10)||
'   SELECT MAX(LOGIN_ID) + 1'||chr(10)||
'   INTO   L_PRIMARY_KEY'||chr(10)||
'   FROM   ADMIN_LOGIN;'||chr(10)||
''||chr(10)||
'   RETURN L_PRIMARY_KEY;'||chr(10)||
'END;'||chr(10)||
'  end; '||chr(10)||
'begin '||chr(10)||
'  :P14_LOGIN_ID := get_pk; '||chr(10)||
'end; ';

wwv_flow_api.create_page_process(
  p_id     => 5468024236793563 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 14,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to get primary key item value.',
  p_process_when_button_id=>5465918912793562 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:ADMIN_LOGIN:P14_LOGIN_ID:LOGIN_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5468209451793563 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 14,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of ADMIN_LOGIN',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table ADMIN_LOGIN.',
  p_process_success_message=> 'Action Processed.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page_process(
  p_id     => 5468416876793563 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 14,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>5466114520793562 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
'No help is available for this page.'
 ,p_last_updated_by => 'JECMCA'
 ,p_last_upd_yyyymmddhh24miss => '20240520231719'
  );
null;
...
'"SOLD_PRICE",'||chr(10)||
'"PROFIT"'||chr(10)||
'from "#OWNER#"."USED_CAR" where ISAVAILABLE = ''SOLD'' AND DEALER_ID = :P14_DEALER_ID';

wwv_flow_api.create_report_region (
  p_id=> 5577110389915413 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 15,
  p_name=> 'Report 1',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5577419229915413 + wwv_flow_api.g_id_offset,
  p_region_id=> 5577110389915413 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'CAR_ID',
  p_column_display_sequence=> 1,
  p_column_heading=> 'CAR_ID',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>1,
  p_disable_sort_column=>'N',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5577516987915414 + wwv_flow_api.g_id_offset,
  p_region_id=> 5577110389915413 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5577629825915414 + wwv_flow_api.g_id_offset,
  p_region_id=> 5577110389915413 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5577726842915414 + wwv_flow_api.g_id_offset,
  p_region_id=> 5577110389915413 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5577806433915414 + wwv_flow_api.g_id_offset,
  p_region_id=> 5577110389915413 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5577929293915414 + wwv_flow_api.g_id_offset,
  p_region_id=> 5577110389915413 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5578002833915414 + wwv_flow_api.g_id_offset,
  p_region_id=> 5577110389915413 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
  p_column_alias=> 'TOTAL_KM_DRIVEN',
  p_column_display_sequence=> 7,
  p_column_heading=> 'TOTAL_KM_DRIVEN',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'N',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5578103950915414 + wwv_flow_api.g_id_offset,
  p_region_id=> 5577110389915413 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5578218447915414 + wwv_flow_api.g_id_offset,
  p_region_id=> 5577110389915413 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 9,
  p_form_element_id=> null,
  p_column_alias=> 'BUYING_DATE',
  p_column_display_sequence=> 9,
  p_column_heading=> 'BUYING_DATE',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'N',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5578321738915414 + wwv_flow_api.g_id_offset,
  p_region_id=> 5577110389915413 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 10,
  p_form_element_id=> null,
  p_column_alias=> 'CAR_AGE',
  p_column_display_sequence=> 10,
  p_column_heading=> 'CAR_AGE',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'N',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5578418870915414 + wwv_flow_api.g_id_offset,
  p_region_id=> 5577110389915413 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 11,
  p_form_element_id=> null,
  p_column_alias=> 'PURCHASE_AMOUNT',
  p_column_display_sequence=> 11,
  p_column_heading=> 'PURCHASE_AMOUNT',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'N',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5578504190915414 + wwv_flow_api.g_id_offset,
  p_region_id=> 5577110389915413 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 12,
  p_form_element_id=> null,
  p_column_alias=> 'RESALE_MRP',
  p_column_display_sequence=> 12,
  p_column_heading=> 'RESALE_MRP',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'N',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5578627486915414 + wwv_flow_api.g_id_offset,
  p_region_id=> 5577110389915413 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5578701820915414 + wwv_flow_api.g_id_offset,
  p_region_id=> 5577110389915413 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 14,
  p_form_element_id=> null,
  p_column_alias=> 'SOLD_PRICE',
  p_column_display_sequence=> 14,
  p_column_heading=> 'SOLD_PRICE',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'N',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5578824349915414 + wwv_flow_api.g_id_offset,
  p_region_id=> 5577110389915413 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 5204528758247503 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_cache_page_yn => 'N'
 ,p_last_upd_yyyymmddhh24miss => '20240513142616'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5214823744247507 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5214908224247507 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 5214823744247507+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5215013727247507 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5215125071247507 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(5206001455247504 + wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_process(
  p_id     => 5215309698247507 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 5215204152247507 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 5215522932247507 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 5215415582247507 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_list (
  p_id=> 5217908876247509 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
  p_display_row_template_id=> 5211225740247506 + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_menu (
  p_id=> 5215611546247507 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
...
prompt  ......Page template 5204528758247503
...
wwv_flow_api.create_template(
  p_id=> 5204528758247503 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Login',
  p_body_title=> '',
...
prompt  ......Page template 5204618770247503
...
wwv_flow_api.create_template(
  p_id=> 5204618770247503 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5204704188247503
...
wwv_flow_api.create_template(
  p_id=> 5204704188247503 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5204812231247503
...
wwv_flow_api.create_template(
  p_id=> 5204812231247503 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5204903386247503
...
wwv_flow_api.create_template(
  p_id=> 5204903386247503 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5205006008247503
...
wwv_flow_api.create_template(
  p_id=> 5205006008247503 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5205122148247504
...
wwv_flow_api.create_template(
  p_id=> 5205122148247504 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5205212757247504
...
wwv_flow_api.create_template(
  p_id=> 5205212757247504 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5205321170247504
...
wwv_flow_api.create_template(
  p_id=> 5205321170247504 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5205406391247504
...
wwv_flow_api.create_template(
  p_id=> 5205406391247504 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Popup',
  p_body_title=> '',
  p_header_template=> c1,
...
prompt  ......Page template 5205502445247504
...
wwv_flow_api.create_template(
  p_id=> 5205502445247504 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5205625690247504
...
wwv_flow_api.create_template(
  p_id=> 5205625690247504 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5205700702247504
...
wwv_flow_api.create_template(
  p_id=> 5205700702247504 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5205827628247504
...
wwv_flow_api.create_template(
  p_id=> 5205827628247504 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5205923225247504
...
wwv_flow_api.create_template(
  p_id=> 5205923225247504 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Button Template 5206001455247504
declare
...
wwv_flow_api.create_button_templates (
  p_id=>5206001455247504 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5206126041247504
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5206126041247504 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5206212394247504
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5206212394247504 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5206309111247504
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5206309111247504 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5206421010247504
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5206421010247504 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5206506289247504
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5206506289247504 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5206600751247504
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5206600751247504 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......region template 5206709827247504
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5206709827247504 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5206824246247504
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5206824246247504 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5206903654247504
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5206903654247504 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 5207004871247504
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5207004871247504 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5207110146247504
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5207110146247504 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5207228431247504
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5207228431247504 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5207324742247504
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5207324742247504 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region-blank" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top">'||chr(10)||
...
prompt  ......region template 5207408767247504
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5207408767247504 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5207507418247504
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5207507418247504 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5207612379247504
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5207612379247504 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 5207719527247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5207719527247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 5207830540247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5207830540247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5207927983247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5207927983247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5208001908247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5208001908247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5208129637247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5208129637247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5208204477247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5208204477247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-body">#BODY#</div>'||chr(10)||
...
prompt  ......region template 5208332292247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5208332292247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 5208423766247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5208423766247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5208517981247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5208517981247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5208610334247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5208610334247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 5208702608247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5208702608247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5208804844247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5208804844247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5208909482247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5208909482247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5209017326247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5209017326247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region-alt" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 5209132064247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5209132064247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5209204767247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5209204767247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="sidebar-region">'||chr(10)||
'<div class="rounded-corner-region-alt" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
...
prompt  ......region template 5209309407247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5209309407247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5209430595247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5209430595247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5209520813247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5209520813247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5209606689247505
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5209606689247505 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region-wizard" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......list template 5209701380247505
...
wwv_flow_api.create_list_template (
  p_id=>5209701380247505 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 5209804284247505
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5209804284247505 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5209910461247505
...
wwv_flow_api.create_list_template (
  p_id=>5209910461247505 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5210014839247505
...
wwv_flow_api.create_list_template (
  p_id=>5210014839247505 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5210115862247505
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5210115862247505 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5210215783247505
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5210215783247505 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5210308863247505
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5210308863247505 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5210411333247505
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5210411333247505 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5210514105247506
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5210514105247506 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5210632500247506
...
wwv_flow_api.create_list_template (
  p_id=>5210632500247506 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5210708769247506
...
wwv_flow_api.create_list_template (
  p_id=>5210708769247506 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5210829278247506
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5210829278247506 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5210904384247506
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5210904384247506 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5211027866247506
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5211027866247506 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5211102709247506
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5211102709247506 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5211225740247506
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5211225740247506 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5211304415247506
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5211304415247506 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5211407303247506
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5211407303247506 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5211509445247506
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5211509445247506 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5211608220247506
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5211608220247506 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 5211704623247506
...
wwv_flow_api.create_row_template (
  p_id=> 5211704623247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5211812750247506
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5211812750247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5211912692247506
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5211912692247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5212032686247506
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5212032686247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5212104931247506
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5212104931247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5212226892247506
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5212226892247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5212324054247506
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5212324054247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5212402491247506
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5212402491247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5212517577247506
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5212517577247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5212609563247506
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5212609563247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5212707025247506
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5212707025247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5212800359247506
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5212800359247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5212910340247506
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5212910340247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5213020219247506
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5213020219247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5213105076247506
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5213105076247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5213201417247506
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 5213201417247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5213310344247506
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 5213310344247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 5214014105247507
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 5214014105247507 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5213403581247506
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5213403581247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5213627128247506
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5213627128247506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5213811569247507
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5213811569247507 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 5214129658247507
begin
wwv_flow_api.create_theme (
  p_id =>5214129658247507 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 21,
  ...
  p_login_template=>5204528758247503 + wwv_flow_api.g_id_offset,
  p_default_button_template=>5206001455247504 + wwv_flow_api.g_id_offset,
  p_default_region_template=>5208610334247505 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>5207612379247504 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>5207719527247505 + wwv_flow_api.g_id_offset,
  ...
  p_default_label_template=>5212910340247506 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>5213201417247506 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>5213403581247506 + wwv_flow_api.g_id_offset,
  p_default_list_template=>5211225740247506 + wwv_flow_api.g_id_offset,
  p_default_option_label=>5212910340247506 + wwv_flow_api.g_id_offset,
  p_default_required_label=>5213105076247506 + wwv_flow_api.g_id_offset);
end;
/
 
prompt  ...build options used by application 110
--
...
prompt  ...messages used by application: 110
--
--application/shared_components/globalization/dyntranslations
prompt  ...dynamic translations used by application: 110
--
...
wwv_flow_api.create_shortcut (
 p_id=> 5218914093247510 + wwv_flow_api.g_id_offset,
 p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 5214212626247507
...
wwv_flow_api.create_auth_setup (
  p_id=> 5214212626247507 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 5214315718247507
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 5214315718247507 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'DATABASE',
...
prompt  ......scheme 5214431654247507
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 5214431654247507 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
